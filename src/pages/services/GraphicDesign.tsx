          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-8 max-w-2xl mx-auto">
              <div className="text-center">
                ...
                <div className="text-xs sm:text-sm text-gray-400 font-medium">Custom Design</div>
              </div>
              <div className="text-center">
              ...
              <div className="text-center">
                ...
                <div className="text-xs sm:text-sm text-gray-400 font-medium">Revisions</div>
              </div>
            </div>
          </motion.div>
        </div>
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <section className="mb-16">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl font-bold text-white mb-8">Our Graphic Design Services</h2>
        ...
        <section className="mb-16">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl font-bold text-white mb-8">Why Choose Our Graphic Design Services?</h2>
        ...
        <section className="mb-16">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl font-bold text-white mb-8">Our Design Process</h2>
          ...
          >
            ...
            <div className="bg-slate-800 rounded-2xl p-8">
              <form className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-xs sm:text-sm font-medium text-gray-300 mb-2">Design Type</label>
                ...
                <div>
                  <label className="block text-xs sm:text-sm font-medium text-gray-300 mb-2">Design Requirements</label>
                  <textarea
                    rows={4}
                    className="w-full px-4 py-3 border border-slate-600 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-transparent bg-slate-700 text-white"
