...
export function Layout({ children }: LayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-slate-950 transition-colors relative overflow-hidden">
      {/* Animated Background */}
      <div className="fixed inset-0 pointer-events-none">
        <div className="absolute inset-0 bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950"></div>
        <motion.div
          className="absolute w-96 h-96 bg-gradient-to-r from-cyan-500/10 to-blue-600/10 rounded-full blur-3xl"
          animate={{
            x: [0, 100, 0],
            y: [0, -50, 0],
          }}
        ...
        />
        <motion.div
          className="absolute w-80 h-80 bg-gradient-to-r from-purple-500/10 to-pink-600/10 rounded-full blur-3xl"
          animate={{
            x: [0, -80, 0],
            y: [0, 60, 0],
          }}
      ...
      {/* Navigation Header */}
      <nav className="bg-slate-900/80 backdrop-blur-xl shadow-2xl border-b border-slate-800/50 transition-colors sticky top-0 z-40">
        <div className="max-w-full mx-auto px-6">
                    ...
                    <div key={section.id} className="relative">
                      ...
                      <AnimatePresence>
                        ...
                        <>
                          ...
                          ></div>
                            <div className="absolute top-full left-0 mt-2 w-64 bg-slate-900/90 backdrop-blur-xl rounded-2xl shadow-2xl border border-slate-700/50 z-20">
                            <div className="p-2">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="relative">
                <button
                  ...
                  className="flex items-center space-x-2 px-4 py-3 bg-slate-800/50 backdrop-blur-sm text-slate-300 rounded-xl hover:bg-slate-700/50 hover:text-emerald-400 transition-all duration-300 text-sm font-bold border border-emerald-400/30"
                >
                ...
                <AnimatePresence>
                  ...
                  <>
                    ...
                    ></div>
                      <div className="absolute right-0 mt-2 w-72 bg-slate-900/90 backdrop-blur-xl rounded-2xl shadow-2xl border border-slate-700/50 z-20">
              ...
              <button
                ...
                className="lg:hidden relative w-12 h-12 bg-slate-800/50 backdrop-blur-sm rounded-xl flex items-center justify-center hover:bg-slate-700/50 transition-all duration-300 shadow-lg border border-emerald-400/30"
              >
          ...
          <AnimatePresence>
            {mobileMenuOpen && (
              <motion.div
                className="lg:hidden border-t border-slate-800/50 bg-slate-900/90 backdrop-blur-xl"
      ...
      <main className="flex-1 p-6 relative">
        <div className="max-w-full mx-auto relative">
          {/* Content Background */}
          <div className="absolute inset-0 bg-slate-900/20 backdrop-blur-3xl rounded-3xl border border-slate-800/30 -z-10"></div>
          {children}
        </div>
      </main>
    </div>
