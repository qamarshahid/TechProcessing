          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-8 max-w-2xl mx-auto">
              <div className="text-center">
                ...
                <div className="text-xs sm:text-sm text-gray-400 font-medium">ROI Increase</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-teal-400">#1</div>
                <div className="text-xs sm:text-sm text-gray-400 font-medium">Search Results</div>
              </div>
              <div className="text-center">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <section className="mb-16">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl font-bold text-white mb-8">Our Google Ads Services</h2>
        ...
        <section className="mb-16">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl font-bold text-white mb-8">Why Choose Google Ads?</h2>
        ...
        <section className="mb-16">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl font-bold text-white mb-8">Our Google Ads Process</h2>
            ...
            <div className="bg-slate-800 rounded-2xl p-8">
              <form className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <label className="block text-xs sm:text-sm font-medium text-gray-300 mb-2">Monthly Ad Budget</label>
                ...
                <div>
                  <label className="block text-xs sm:text-sm font-medium text-gray-300 mb-2">Google Ads Goals</label>
                  <textarea
                    rows={4}
                    className="w-full px-4 py-3 border border-slate-600 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-transparent bg-slate-700 text-white"
