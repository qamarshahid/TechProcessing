      ...
      <div className="flex flex-col lg:flex-row gap-4">
        ...
        <div className="flex-1">
          <div className="relative">
            <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-muted dark:text-gray-500" />
            <input
              type="text"
              value={searchTerm}
        ...
        <div className="flex flex-wrap gap-3">
          ...
          {filterOptions.statuses && (
            <select
              ...
              className="px-4 py-3 border border-gray-300 dark:border-slate-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-surface2 text-gray-900 dark:text-fg"
            >
          ...
          {hasActiveFilters && (
            <button
              ...
              className="px-4 py-3 bg-gray-100 dark:bg-surface2 text-gray-700 dark:text-muted rounded-lg hover:bg-gray-200 dark:hover:bg-slate-600 transition-colors flex items-center"
            >
