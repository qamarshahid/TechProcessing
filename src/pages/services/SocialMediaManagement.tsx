          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-8 max-w-2xl mx-auto">
              <div className="text-center">
                <div className="text-3xl font-bold text-accent2">24/7</div>
                <div className="text-xs sm:text-sm text-muted font-medium">Management</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-accent400">400%</div>
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <section className="mb-16">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl font-bold text-fg mb-8">Our Social Media Management Services</h2>
        ...
        <section className="mb-16">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl font-bold text-fg mb-8">Why Choose Our Social Media Management?</h2>
        ...
        <section className="mb-16">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl font-bold text-fg mb-8">Our Management Process</h2>
          ...
          >
            ...
            <div className="bg-surface rounded-2xl p-8">
              <form className="space-y-6">
                ...
                <div>
                  <label className="block text-xs sm:text-sm font-medium text-muted mb-2">Goals</label>
                  <textarea
                    rows={4}
                    className="w-full px-4 py-3 border border-slate-600 rounded-lg focus:ring-2 focus:ring-ring focus:border-transparent bg-surface2 text-fg"
