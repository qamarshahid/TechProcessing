...
-- Migration: 20250824220000_add_agent_system.sql
...
-- These would be enabled in production with proper Supabase auth integration
-- For now, we'll rely on application-level security in the NestJS backend
...
-- Insert sample agent data (optional - for testing)
-- INSERT INTO users (email, password, full_name, role, is_active) 
-- VALUES ('agent1@example.com', '$2a$12$hash', 'John Agent', 'AGENT', true);

-- INSERT INTO agents (user_id, agent_code, sales_person_name, closer_name) 
-- VALUES ((SELECT id FROM users WHERE email = 'agent1@example.com'), 'AG001', 'John Agent', 'John Agent');
