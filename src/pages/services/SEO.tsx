      ...
      <nav className="sticky top-0 z-50 bg-bg1/90 backdrop-blur-md border-b border-outline">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <Link to="/" className="flex items-center space-x-2 text-accent2 hover:text-accent3 transition-colors touch-manipulation touch-manipulation">
              <ArrowLeft className="h-4 w-4 sm:h-5 sm:w-5" />
              <span className="font-semibold text-xs sm:text-sm sm:text-base">Back to Home</span>
            </Link>
            <div className="flex items-center space-x-2 sm:space-x-4">
              <a href={`tel:${appConfig.contact.phone.replace(/\D/g, '')}`} className="text-muted hover:text-accent2 transition-colors touch-manipulation p-2 touch-manipulation">
                <Phone className="h-4 w-4 sm:h-5 sm:w-5" />
              </a>
              <a href="#contact" className="bg-accent1 hover:bg-accent1 text-fg px-3 sm:px-4 py-2 rounded-lg font-medium transition-colors touch-manipulation text-xs sm:text-sm sm:text-base touch-manipulation">
      ...
      <section className="py-16 bg-gradient-to-br from-emerald-900/20 to-accent900/20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-base sm:text-lg sm:text-lg sm:text-xl text-muted mb-8 max-w-3xl mx-auto leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-3 sm:gap-4 justify-center mb-8 sm:mb-8 sm:mb-12">
              <a
                href="#contact"
              ...
              >
                <Search className="h-4 w-4 sm:h-5 sm:w-5 mr-2 group-hover:animate-pulse" />
                Get Free SEO Audit
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-8 max-w-2xl mx-auto">
              <div className="text-center">
                <div className="text-3xl font-bold text-accent2">400%</div>
                <div className="text-xs sm:text-sm text-muted font-medium">More Traffic</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-accent400">#1</div>
                <div className="text-xs sm:text-sm text-muted font-medium">Page Rankings</div>
              </div>
              <div className="text-center">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <section className="mb-16">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl font-bold text-fg mb-8">Our SEO Services</h2>
        ...
        <section className="mb-16">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl font-bold text-fg mb-8">Why Choose Our SEO Services?</h2>
        ...
        <section className="mb-16">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl font-bold text-fg mb-8">Our SEO Process</h2>
          ...
          >
            ...
            <div className="bg-surface rounded-2xl p-8">
              <form className="space-y-6">
                ...
                <div>
                  <label className="block text-xs sm:text-sm font-medium text-muted mb-2">SEO Goals</label>
                  <textarea
                    rows={4}
                    className="w-full px-4 py-3 border border-slate-600 rounded-lg focus:ring-2 focus:ring-ring focus:border-transparent bg-surface2 text-fg"
