      ...
      <div className="bg-white dark:bg-slate-800 rounded-xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-slate-700">
          <div className="flex items-center">
            ...
            <div>
              <h2 className="text-xl font-bold text-gray-900 dark:text-white">Send Payment Link</h2>
              <p className="text-sm text-gray-600 dark:text-gray-400">{link.title}</p>
            </div>
          </div>
          <button
            onClick={onClose}
              ...
              <div className="p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg border border-purple-200 dark:border-purple-800">
                ...
                <div className="flex items-center space-x-2">
                  <input
                    ...
                    value={paymentUrl}
                    readOnly
                    className="flex-1 px-3 py-2 bg-white dark:bg-slate-700 border border-purple-200 dark:border-purple-700 rounded-lg text-sm font-mono text-gray-900 dark:text-white"
                  />
                  <button
