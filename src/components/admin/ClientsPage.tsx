          ...
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between p-6 border-b border-gray-200">
              <div className="flex items-center">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-900">Create New Client Account</h3>
                  <p className="text-sm text-gray-600">Create both client profile and portal access</p>
                </div>
              </div>
              <button
            ...
            <form onSubmit={handleCreateClient} className="p-6 space-y-4">
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
                <div className="flex items-center">
                  ...
                  <div>
                    <h4 className="text-sm font-medium text-blue-800">Portal Access</h4>
                    <p className="text-sm text-blue-700">This will create both a client profile and portal login access.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">If blank, a temporary password will be generated</p>
                </div>
