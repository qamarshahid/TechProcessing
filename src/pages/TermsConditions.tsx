    ...
    <div className="min-h-screen bg-bg1 text-fg">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-fg mb-6">
              Terms & <span className="text-accent2">Conditions</span>
            </h1>
      ...
      <section className="py-16 lg:py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="bg-surface/50 rounded-2xl p-6 border border-outline/50 mb-8">
              <div className="flex items-start space-x-3">
                <AlertTriangle className="h-6 w-6 text-amber-400 mt-1 flex-shrink-0" />
                <div>
                  <h3 className="text-lg font-semibold text-fg mb-2">Important Information</h3>
            ...
            <h2 className="text-3xl font-bold text-fg mb-8">Terms & Conditions</h2>
            ...
            <h3 className="text-2xl font-bold text-fg mt-12 mb-6">1. General Definitions</h3>
            <ul className="text-muted text-lg leading-relaxed mb-8 space-y-2">
              <li><strong className="text-accent2">Agreement:</strong> The document between you and the Tech Processing LLC.</li>
              <li><strong className="text-accent2">Application:</strong> All our websites, any administration tools as well as software offered by us or our partners.</li>
              <li><strong className="text-accent2">Business Day:</strong> Day not including Saturday, Sunday or public holidays.</li>
              <li><strong className="text-accent2">Customer Information:</strong> All data or contents you give or utilize in our services.</li>
              <li><strong className="text-accent2">Intellectual Property Rights:</strong> All patents, trademarks, copyrights, designs, databases, know how and confidential information.</li>
              <li><strong className="text-accent2">Personal Data:</strong> According to the detailed data protection legislation.</li>
              <li><strong className="text-accent2">Service Fee:</strong> Any amount which we charge any person in connection with our services.</li>
              <li><strong className="text-accent2">Software:</strong> Any software that we use or which we have used on our behalf.</li>
              <li><strong className="text-accent2">Users:</strong> All users of your business that have a permission to utilize our services.</li>
            </ul>

            <h3 className="text-2xl font-bold text-fg mt-12 mb-6">2. Our Obligations</h3>
            ...
            <h3 className="text-2xl font-bold text-fg mt-12 mb-6">3. Customer Obligations</h3>
            ...
            <h3 className="text-2xl font-bold text-fg mt-12 mb-6">4. Warranties</h3>
            <p className="text-muted text-lg leading-relaxed mb-8">
            ...
            <h3 className="text-2xl font-bold text-fg mt-12 mb-6">5. Service Specific Conditions</h3>
            <ul className="text-muted text-lg leading-relaxed mb-8 space-y-2">
              <li><strong className="text-accent2">Number Assignment:</strong> Numbers are assigned randomly or assigned to use with the Service.</li>
              <li><strong className="text-accent2">Number Usage:</strong> We will reclaim your number in case you stop using it within a 3 month period (free plan) or you stop paying your subscription fee (paid plan).</li>
              <li><strong className="text-accent2">Call and Voicemail Recording:</strong> Recordings will be stored according to your commands and destroyed after the required term.</li>
              <li><strong className="text-accent2">Support:</strong> Supports are offered through our help-desk or support email.</li>
              <li><strong className="text-accent2">Service Communications:</strong> We can email you with the updates and marketing communications and you can opt out anytime.</li>
            </ul>

            <h3 className="text-2xl font-bold text-fg mt-12 mb-6">6. Charges</h3>
            <p className="text-muted text-lg leading-relaxed mb-6">
            ...
            <h3 className="text-2xl font-bold text-fg mt-12 mb-6">7. Service Provision</h3>
            <p className="text-muted text-lg leading-relaxed mb-8">
            ...
            <h3 className="text-2xl font-bold text-fg mt-12 mb-6">8. Security</h3>
            <p className="text-muted text-lg leading-relaxed mb-8">
            ...
            <h3 className="text-2xl font-bold text-fg mt-12 mb-6">9. Agreement and Release</h3>
            <p className="text-muted text-lg leading-relaxed mb-8">
            ...
            <h3 className="text-2xl font-bold text-fg mt-12 mb-6">10. Liability Limitation</h3>
            <p className="text-muted text-lg leading-relaxed mb-8">
            ...
            <h3 className="text-2xl font-bold text-fg mt-12 mb-6">11. Intellectual Property Rights</h3>
            <p className="text-muted text-lg leading-relaxed mb-8">
            ...
            <h3 className="text-2xl font-bold text-fg mt-12 mb-6">12. Third Party Dealings</h3>
            <p className="text-muted text-lg leading-relaxed mb-8">
            ...
            <h3 className="text-2xl font-bold text-fg mt-12 mb-6">13. Data Protection</h3>
            <p className="text-muted text-lg leading-relaxed mb-8">
            ...
            <h3 className="text-2xl font-bold text-fg mt-12 mb-6">14. Force Majeure</h3>
            <p className="text-muted text-lg leading-relaxed mb-8">
            ...
            <h3 className="text-2xl font-bold text-fg mt-12 mb-6">15. Confidentiality</h3>
            <p className="text-muted text-lg leading-relaxed mb-8">
            ...
            <h3 className="text-2xl font-bold text-fg mt-12 mb-6">16. Notices</h3>
            <p className="text-muted text-lg leading-relaxed mb-8">
            ...
            <h3 className="text-2xl font-bold text-fg mt-12 mb-6">17. Assignment</h3>
            <p className="text-muted text-lg leading-relaxed mb-8">
            ...
            <h3 className="text-2xl font-bold text-fg mt-12 mb-6">18. Entire Agreement</h3>
            <p className="text-muted text-lg leading-relaxed mb-8">
      ...
      <section className="py-16 lg:py-24 bg-bg2/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div 
            ...
            className="text-center"
          >
            <h2 className="text-3xl font-bold text-fg mb-8">Questions About Our Terms & Conditions?</h2>
